import { __Query } from '../query/index'
import { __Sandbox } from '../sandbox/index'
import { __Animate } from '../animate/index'
import { __Promise } from '../promise/index'
import { __Scroll } from '../scroll/index'
import { __Touch } from '../touch/index'
import { __Loader } from '../loader/index'

export const proto = (window) => {
  ...
  window.$$ = window.query = __Query(window)

  // sandbox

  window.extendProperty("sandbox", __Sandbox())
  ...
  window.Scroll = __Scroll()(window, window.document, window.Math)
  ...
  window.Touch = __Touch(window, window.document, undefined)

  // Loader

  Object.defineProperty(window, "Loader", {
    configurable: true,
    writable: true
  })
  window.Loader = __Loader(window)
