...
define('~/dom', [], function (require, module, exports) {
  ...
  var DOM = function () {
    ...
    _createClass(DOM, [{
      key: 'init',
      value: function init(module, sandbox, helper, css) {
      ...
      key: 'creat',
      value: function creat(root, node, _creat) {
      ...
      key: 'save',
      value: function save(source, data) {
        this.DATA = data;
        this.SOURCE = source;
      }
      ...
      key: 'space',
      value: function space(window, container) {
      ...
      key: 'uuid',
      value: function uuid(root, node, _uuid) {
      ...
      key: 'get',
      value: function get(id, callback, prefixe, suffix, source) {
      ...
      key: 'set',
      value: function set(space, id, source, pid) {
      ...
      key: 'take',
      value: function take(space, id, prefixe, suffix) {
      ...
      key: 'realpath',
      value: function realpath(root, url) {
      ...
      key: 'insert',
      value: function insert(root, compiler) {
        var uuid = root.uuid;
      ...
      key: 'into',
      value: function into(root, uuid, puid) {
      ...
      key: 'append',
      value: function append(root, node) {
        var uuid = node.uuid;
      ...
      key: 'creatFragment',
      value: function creatFragment(uuid, creat) {
      ...
      key: 'createElement',
      value: function createElement(root, node, uuid, name) {
      ...
      key: 'setAttribute',
      value: function setAttribute(root, node, name, value, scope) {
        var text = '';
        var uuid = node.uuid;
      ...
      key: 'createTextNode',
      value: function createTextNode(root, node, value, scope) {
        var text = '';
        var uuid = node.uuid;
      ...
      value: function createShadowRoot(root, node, dom, scope) {
        var uuid = node.uuid;
      ...
      key: 'getElementById',
      value: function getElementById(uuid, scopeid) {
        var element;
      ...
      key: 'getValueByMagic',
      value: function getValueByMagic(scope, magic) {
        var result;
        var handle;
      ...
      key: 'getValueByRoute',
      value: function getValueByRoute(scope, origin) {
        var result;
        var handle;
      ...
      key: 'getOriginType',
      value: function getOriginType(origin) {
        var html = false;
        var watch = true;
      ...
      key: 'getRootScope',
      value: function getRootScope(scope) {
      ...
      key: 'variable',
      value: function variable(root, scope, value, callback, uuid, type) {
        var origin;
        var identity = {};
      ...
      key: 'watch',
      value: function watch(root, scope, origin, callback, uuid) {
      ...
      key: 'react',
      value: function react(root, scope, route, callback, uuid) {
        var that = this;
        ...
        this.entanglement.initial(route, []).push({
          caller: callback,
          uuid: uuid
        });
      ...
      key: 'parallel',
      value: function parallel(reality, virtual) {
        var that = this;
      ...
      key: 'setProperty',
      value: function setProperty(root, node) {
        var that = this;
        var uuid = node.uuid;
      ...
      key: 'attributeRule',
      value: function attributeRule(root, node, name, value, scope) {
        var that = this;
          ...
          case 'transform':
            ...
            this.mission[root.order].events.unshift(function (window) {
              ...
              dom.Touch().on(value[1] || 'tap', function (event) {
                ...
                App.trigger('transform', {
                  id: id,
                  od: App.id,
                  param: param ? param.paramsToObject() : {},
                  data: eventa ? eventa.paramsToObject() : {},
                  event: event
                });

                // transform module

                App.transform.to(id, param, null, {
                  touches: event
                });
              ...
              switch (scopeEventName.split(' ')[0]) {
                ...
                case 'tap':
                  ...
                  dom.Touch().on(scopeEventName, function (event) {
                    ...
                    App.trigger('touch', {
                      data: eventData ? eventData.paramsToObject() : {},
                      event: event
                    });
                  });
      ...
      key: 'tagRule',
      value: function tagRule(root, node, scope, react) {
        var that = this;
        var uuid = node.uuid;
              ...
              if (finite) {
                ...
                config.extend({
                  ...
                  getInfiniteDataFiller: function getInfiniteDataFiller(tabview, key, rekey) {
                    ...
                    tabview.children[0].trigger('show', {
                      key: key
                    });
      ...
      key: 'sign',
      value: function sign(tag, command, _sign, index, wrap, boolean, repatriate) {
      ...
      key: 'datar',
      value: function datar(scope, command, ext, index, ignore) {
      ...
      key: 'commands',
      value: function commands(name, node) {
        var dom = this.DOMS[node.uuid];
        var command = node.attributes;
      ...
      key: 'observer',
      value: function observer(dom, callback) {
        dom.observer({
          childList: true,
          subtree: true,
          characterData: true
      ...
      key: 'reflow',
      value: function reflow(scroller) {
        if (scroller) {
      ...
      key: 'step',
      value: function step(root, node, scope) {
      ...
      key: 'walker',
      value: function walker(nodes, callback) {
        var node;
      ...
      key: 'include',
      value: function include(root, target, source, data, replace, inset) {
      ...
      key: 'render',
      value: function render(id, source, data) {
      ...
      key: 'compile',
      value: function compile(root, nodes, scope, creat) {
        var uuid = root.uuid;
        var node;
      ...
      key: 'dispatch',
      value: function dispatch(order, group) {
      ...
      key: 'debug',
      value: function debug(tagname, type, e, end) {
