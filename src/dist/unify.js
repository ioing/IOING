...
(function () {
  ...
  var rootScript = document.getElementById('ioing') || document.getElementsByTagName('script')[0];

  var __dir = function () {

    // get root

    var root = rootScript.getAttribute('root');
    var paths = [];
  ...
  if ('serviceWorker' in navigator) {
    var service = rootScript.getAttribute('service-worker');
  ...
  window.__defineUnify__ = function () {
    ...
    return function (window) {
      ...
      window.Object.defineProperty(window.Object.prototype, "extendProperty", {
        configurable: true,
        writable: true
      });
      ...
      window.Object.defineProperty(window.Object.prototype, "extendProperties", {
        configurable: true,
        writable: true
      });
      ...
      for (var key in window) {
        ...
        if (vendor) {
          ...
          if (start > 'A' || start < 'Z') {
            try {
              if (!window[rekey]) {
                Object.defineProperty(window, rekey, {
                  configurable: true,
                  writable: true
                });
