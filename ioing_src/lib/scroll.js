...
define('~/scroll', [], function (require, module, exports) {
	...
	module.exports = function (window, document, Math) {
		...
		const gCS = window.getComputedStyle
	  	...
	  	const dP  = function (px) { return px * UI.scale }
	  	...
	  	class Scroll {
			...
			_drawing (callback) {
				...
				rAF(() => {
					...
					this._drawKeyFrame.call(this, callback || noop)
				})
			}
			...
			_pulling (el, r) {
				let u = 1
				  ...
				  , status = 0
				  , style = el.style
				  , threshold = -dP(el.getAttribute('threshold') || 50)
				  , riseOffset = -dP(el.getAttribute('rise') || threshold)
